...
import 'package:dental/presentation/views/main/category/sub_category_view.dart';
...
class AppRouter {
  ...
  static const String subcategory = '/subcategory'; // Define subcategory route
      ...
      case subcategory:
        ...
        return MaterialPageRoute(
            builder: (_) => SubCategoryView(
                category:
                    category)); // Add subcategory route case with category argument
      default:
