import 'package:dental/domain/usecases/delivery_info/get_selected_delivery_info_usecase.dart';
...
Future<void> init() async {
  ...
  sl.registerLazySingleton<ProductRemoteDataSource>(
    () => ProductRemoteDataSourceImpl(databaseReference: sl()),
  );
  ...
  sl.registerLazySingleton<CategoryRemoteDataSource>(
    () => CategoryRemoteDataSourceImpl(databaseReference: sl()),
  );
  ...
  sl.registerLazySingleton<CartRemoteDataSource>(
    () => CartRemoteDataSourceSourceImpl(firebaseDatabase: sl()),
  );
  ...
  sl.registerLazySingleton<DeliveryInfoRemoteDataSource>(
    () => DeliveryInfoRemoteDataSourceImpl(database: sl()),
  );
  ...
  sl.registerLazySingleton<OrderRemoteDataSource>(
    () => OrderRemoteDataSourceSourceImpl(firebaseDatabase: sl()),
  );
  ...
  sl.registerLazySingleton<UserRemoteDataSource>(
    () => UserRemoteDataSourceImpl(database: sl()),
  );
  ...
  sl.registerLazySingleton<DatabaseReference>(() => firebaseDatabase);
}
