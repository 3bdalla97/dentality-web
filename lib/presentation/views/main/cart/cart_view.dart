                    ...
                    children: [
                      Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            Text(
                              'Total (${state.cart.fold(0.0, (previousValue, element) => (element.quantity + previousValue)).toInt()} items)',
                              style: const TextStyle(fontSize: 16),
                            ),
                            Text(
                              'LE ${state.cart.fold(0.0, (previousValue, element) => ((element.priceTag.price * element.quantity) + previousValue))}',
