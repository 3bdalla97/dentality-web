...
import 'package:dental/domain/entities/cart/cart_item.dart';
                        ...
                        children: [
                          SizedBox(
                            ...
                            child: cartItem == null
                                ...
                                : Text(
                                    r'LE' +
                                        (cartItem!.priceTag.price.toDouble())
                                            .toString(),
                                    style: const TextStyle(
                                      fontSize: 16,
                                      fontWeight: FontWeight.w600,
              ...
              Column(
                children: [
                  Padding(
                    padding: const EdgeInsets.fromLTRB(4, 8, 4, 0),
                    child: Text(
                      'Total \n${(cartItem!.priceTag.price.toDouble() * cartItem!.quantity).toString()} LE',
                      style: const TextStyle(
                        fontSize: 16,
                        fontWeight: FontWeight.w600,
                      ),
