...
import 'package:dental/core/router/app_router.dart';
import 'package:dental/presentation/blocs/filter/filter_cubit.dart';
...
class CategoryCard extends StatelessWidget {
  ...
  const CategoryCard({Key? key, this.category, this.isSubCategory})
      : super(key: key);
    ...
    return GestureDetector(
      onTap: () {
        if (isSubCategory == true) {
          Navigator.pushNamed(context, AppRouter.subcategory,
              arguments: category);
        } else {
          // if (category != null) {
