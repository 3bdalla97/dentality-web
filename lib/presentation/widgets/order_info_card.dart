...
class OrderInfoCard extends StatelessWidget {
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  "Order Items : ${getQuantity(orderDetails)}",
                  style: const TextStyle(
                    fontSize: 14,
                  ),
                ),
  ...
  int getQuantity(OrderDetails? orderDetails) {
    if (orderDetails != null) {
      return orderDetails.orderItems.fold(0,
          (previousValue, element) => previousValue + element.quantity.toInt());
    } else {
      return 0;
    }
  }
